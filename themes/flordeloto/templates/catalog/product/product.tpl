    ...
    <div class="container product-layout">
      ...
      <div class="product-summary">
        ...
        <form action="{$urls.pages.cart|escape:'html':'UTF-8'}" method="post" id="add-to-cart-or-refresh">
          ...
          <input type="hidden" name="id_product" value="{$product.id_product|default:$product.id|escape:'html':'UTF-8'}">
          <input type="hidden" name="id_customization" value="{$product.id_customization|default:0|escape:'html':'UTF-8'}">
