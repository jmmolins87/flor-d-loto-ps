<footer id="footer" class="site-footer">
  <div class="container site-footer__inner">
    <section class="site-footer__brand" aria-label="Flor de Loto">
      ...
      <p>Arreglos florales para cada ocasion, regalos y detalles con un estilo natural y cuidado.</p>
    </section>
    ...
    <address class="site-footer__contact">
      ...
      <a href="{$urls.pages.contact|escape:'html':'UTF-8'}">Consultar opciones de contacto</a>
    </address>
  </div>
